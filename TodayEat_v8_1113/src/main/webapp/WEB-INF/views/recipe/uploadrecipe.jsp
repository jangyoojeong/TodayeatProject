	   ...
	   function check() {
		   ...
		   if ($.trim($("#cok_title").val()) == '') {
			   ...
			   if(alert('요리 팁을 입력하지 않으셨습니다. 그대로 진행하시겠습니까?')); {
				...
				if (confirm('레시피를 등록하시겠습니까?')==false) {
					return false;	
				}
				   
				   $.ajax({
					 	//url: "upload_recipe.do?step_arr=" + imsi_arr + "&complete_img=" + complete,
					 	url: "upload_recipe.do?fo_nu=" + fo_nu + "&st_nu=" + st_nu,
					 	//data: imsi_arr,
					 	data: $('#f1').serialize(),
					 	//dataType    :   "json",
					 	...
					 	error : function(request, status, error){
					 		alert('예기치못한 에러가 발생하여 레시피 등록이 미처리되었습니다.');
					 		location.href = "my_recipe_search.do";
					 	}
				   });
		   ...
		   <form action="upload_recipe.do" method="post" id = "f1" enctype="multipart/form-data">
		      ...
		      <table  class = "main" align = "center" border = "0">
		            ...
		            <tr>
		               <td colspan = "3">
		                  <div class = "icon" align = "center">
		                     <img src="${pageContext.request.contextPath}/resources/img/icon/uploadRecipe.svg"/>
		                  </div>
		               </td>
		            <tr>
		         </thead>
		         ...
		         <tbody>
		            <tr>
		               <th>레시피 제목</th>
		               <td colspan="2" ><input type = "text" id = "cok_title" name = "recipe_title" autofocus><input type = "hidden" name = "nickname" value = "${login_nickname }"></td>
		               
		            </tr>
		            
		            <tr>
		               <th>요리 소개</th>
		               <td colspan="2" ><input type = "text" id = "cok_intro" name = "recipe_intro"></td>
		            </tr>
		            ...
		            <tr>
		               ...
		               <td>
		                  <table id = "food" cellspacing = "0" cellpadding = "0">
		                     <tr id = "food1">
		                        <td><input type = "text" name = "food1_tx1" placeholder = "예) 돼지고기" required></td>
		                        <td><input type = "text" name = "food1_tx2"  placeholder = "예) 300g" required></td>
		                     </tr>
		                     <tbody></tbody>
		                  </table>
		               </td>
		            ...
		            <!--    <td class = "text"><strong>Step1</strong></td> -->
		               <td colspan = "3">
		                  <table id = "step">
		                     <tr id = "step1">
		                        <td class = "text"><strong>Step1</strong></td>
		                        <td><textarea name = "steptext_1" placeholder = "예) 소고기는 기름기를 떼어내고 적당한 크기로 썰어주세요" id = "steptext1" required></textarea></td>
		                        <td>               		
		                        	<div class = "step_img" id = stepPhothHolderBox_1 is_over = "0">
			                        	<div id = "divStepPhotoHolder_1" style = "position:relative;">
				                        		<a id = "btnDelStepPhoto_1" class = "pic_del" href="javascript:delStepPhoto(1);" style = "display:none;"></a>
				                  				<a href = "javascript:" onclick = "fileUploadAction(1);">
				                  					<!-- <img id = "stepPhotoHolder_1" onclick = "browseStepFile(1)" src = "icon/insert_img.svg" style = "cursor:pointer"/> -->
				                  					<img id = "stepPhotoHolder_1" src = "${pageContext.request.contextPath}/resources/img/icon/insert_img.svg" style = "cursor:pointer;"/>
				                  				</a>
												<input type = "file" id = "input_img_1" name = "step_1"/>
										</div>
		                  			</div>
		                  		</td>
		                     </tr>
		               		...
		               		<div class = "complete_img" id = "WorkPhothHolderBox_1" is_over = "0">
		               			<div id = "divWorkPhotoHolder_1" class = "complete_pic" style = "position:relative; left:0px; top: 0px;">
		               					...
		               					<a href = "javascript:" onclick = "fileUploadAction_work(1);">
		               						<img id = "WorkPhotoHolder_1" src = "${pageContext.request.contextPath}/resources/img/icon/insert_img.svg" style = "cursor:pointer;"/>
										</a>
		            ...
		            <tr>
		               <th>요리 팁</th>
		               <td colspan = "3"><textarea name = "recipe_tip" id = "recipe_tip" placeholder = "예) 고기요리에는 소금보다 설탕을 먼저 넣어야 단맛이 겉돌지 않고 육질이 부드러워요."></textarea></td>
		            </tr>
		         </tbody>
		         ...
		         <tfoot class = "tfoot">
		            <tr>
		               <td colspan = "4" align = "center">
		                  <input type = "button" id = "insert" value = "등록" onclick = "check();">
		                  <a href = "my_recipe_search.do"><input type = "button" id = "cancle" value = "취소"></a>
		               </td>
		            </tr>
		         </tfoot>
		      </table>
